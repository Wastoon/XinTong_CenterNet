...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--task', default='ctdet',
                             help='ctdet ')
    self.parser.add_argument('--dataset', default='XinTong',
                             help='XinTong')
    self.parser.add_argument('--exp_id', default='XinTongTest')
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [1024, 1024], 'num_classes': 26,
